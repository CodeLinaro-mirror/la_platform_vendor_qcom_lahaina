...
BOARD_PREBUILT_BOOTIMAGE := device/qcom/lahaina/boot.img
...
TARGET_USES_SMMU_PROXY := false

BOARD_KERNEL_CMDLINE := video=vfb:640x400,bpp=32,memsize=3072000 loglevel=8
